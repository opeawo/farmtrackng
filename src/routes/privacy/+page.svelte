...
<div class="px-4 -mt-4 space-y-4 pb-24 max-w-2xl mx-auto">
	...
	<section class="bg-white rounded-2xl p-5 shadow-sm border border-base-300/50 space-y-2">
		...
		<ul class="text-sm text-base-content/80 list-disc pl-5 space-y-1">
			...
			<li>To run, maintain, debug, and improve the FarmPaddy service.</li>
	...
	<section class="bg-white rounded-2xl p-5 shadow-sm border border-base-300/50 space-y-2">
		...
		<p class="text-sm text-base-content/80 leading-relaxed">
			FarmPaddy is not designed for children under 13. We don't knowingly collect information from children. If you believe a child has used the service and given us personal information, contact us and we will delete it.
		</p>
	</section>
